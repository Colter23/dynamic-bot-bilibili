...
public class BilibiliPublisherPlugin private constructor(
    private val runtime: BilibiliPublisherRuntime,
) :
    ...
    override suspend fun fetchLatestPublisherUpdate(
        ...
        return runtime.fetchLatestPublisherUpdate(request)
    }
