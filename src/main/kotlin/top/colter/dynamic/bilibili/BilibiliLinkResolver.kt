        ...
        return LinkResolution.Preview(
            ...
            preview = LinkPreview(
                ...
                metrics = listOfNotNull(
                    ...
                    snapshot.coin.toDisplayMetric("coin"),
                    snapshot.favorite.toDisplayMetric("favorite"),
                    snapshot.comment.toDisplayMetric("comment"),
                    snapshot.share.toDisplayMetric("share"),
                ),
